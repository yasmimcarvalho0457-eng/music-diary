...
async function renderPublicProfile() {
  ...
  publicProfile.innerHTML = `
    <div class="profile-cover banner-bg" style="background-image: linear-gradient(rgba(255,255,255,.15), rgba(255,180,235,.25)), url('${viewedProfile.banner || defaultBanner}'); --banner-desktop-size:${viewedProfile.bannerDesktopZoom ?? viewedProfile.bannerZoom ?? 1}; --banner-desktop-x:${viewedProfile.bannerDesktopX ?? viewedProfile.bannerX ?? 50}%; --banner-desktop-y:${viewedProfile.bannerDesktopY ?? viewedProfile.bannerY ?? 50}%; --banner-mobile-size:${viewedProfile.bannerMobileZoom ?? 1}; --banner-mobile-x:${viewedProfile.bannerMobileX ?? 50}%; --banner-mobile-y:${viewedProfile.bannerMobileY ?? 50}%;">
    ...
    <div class="profile-main">
      ...
      <div class="profile-widgets">
        ...
        <div class="mini-window">
          ...
          <p><a class="soft-link" href="public-playlists.html?uid=${viewedUserId}">Ver playlists públicas</a></p>
        </div>
      </div>
    </div>
  `;
